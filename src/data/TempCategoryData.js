...
export const categoryData = {
    "startup": {
        ...
        intro: [
            "Starting a business is an exciting journey, but the legal formalities can be overwhelming. At Delhi Filings, we simplify the incorporation process, ensuring that your startup is legally compliant from day one.",
    ...
    "trademark": {
        ...
        intro: [
            ...
            "Delhi Filings provides comprehensive IP services, including Trademark Search, Filing, Objection Handling, and Renewal, ensuring complete protection for your brand."
        ],
        benefits: [
    ...
    "compliance": {
        ...
        intro: [
            ...
            "Delhi Filings acts as your virtual CFO and HR department, handling PF/ESI returns, generating payslips, and maintaining your books of accounts."
        ],
        benefits: [
